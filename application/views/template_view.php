        ...
        <div class="main_container">
            <div class="col-md-3 left_col menu_fixed">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="#" class="site_title"><i class="fa fa-book"></i> <span>SIP</span></a>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo base_url() ?>assets/images/upload/profile/default.png" alt=""><?php echo $this->db->where('USERNAME', $this->session->userdata('username'))->get('admin')->row('FULLNAME'); ?>
            ...
            <footer>
                <div class="pull-right">
                    &copy; <?= date('Y'); ?> - Perpustakaan Web Lanjut
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
